...
export async function POST(req: NextRequest) {
  try {
    ...
    const styleMap: Record<string, string> = {
      ...
      gta: "A GTA V loading screen character portrait, bold outlines, saturated colors, stylized realism, Grand Theft Auto artwork style by Stephen Bliss, no text no words",
      superhero: "A comic book superheroine portrait, wearing a unique colorful themed superhero costume with creative patterns, flowing cape, confident heroic pose, vibrant comic book colors, dynamic action style, original unique superhero design",
      ...
      simpsons: "A character drawn exactly in The Simpsons cartoon style, bright yellow skin color, round bulging eyes with black pupils, overbite, four fingers on each hand, Springfield background, Matt Groening cartoon art style, 2D flat cartoon, The Simpsons TV show screenshot",
      ...
      'pop-art': "A pop art portrait in the style of Andy Warhol and Roy Lichtenstein, bold primary colors, halftone dots, thick black outlines, comic book pop art, no text no words",
      ...
      'comic-book': "A comic book character portrait, bold black ink outlines, cell shading, vivid colors, action comic panel art style, superhero comic illustration, no text no speech bubbles",
      lego: "A LEGO minifigure toy photograph, classic yellow plastic LEGO skin, simple curved smile, dot eyes, C-shaped hands, blocky rectangular torso and legs, plastic toy texture, LEGO hair piece, colorful LEGO bricks in background, product photography style, sharp focus",
      ...
      'retro-80s': "A retro 1980s synthwave portrait, neon pink and blue lighting, laser grid background, VHS aesthetic, outrun synthwave art style, no text no words no letters",
